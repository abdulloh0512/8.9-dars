  ...
  return (
    <div className="bg-white">
      <header className=" inset-x-0 top-0 z-50 fixed">
        <nav
          className="flex items-center justify-between p-6 lg:px-8 bg-slate-500 text-white"
          aria-label="Global"
        >
          <div className="flex lg:flex-1">
            <a href="#" className="-m-1.5 p-1.5">
              <h1 className="text-[30px]">ABDULLOH</h1>
            </a>
          </div>
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-25">
          <div className="text-center">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
              Abdulloh's 8.9-homework
            </h1>
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Quaerat
              tempora voluptate placeat incidunt autem. At ullam iste culpa
              tenetur. Aut totam quibusdam dolorem harum voluptatibus
              accusantium iure veritatis pariatur. Nulla illo commodi quibusdam
              est, quisquam minus recusandae incidunt voluptatum, rerum
              consequatur libero. Laboriosam quod voluptatum blanditiis, fugit
              neque in architecto.
            </p>
